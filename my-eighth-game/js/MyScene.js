import {Player, Virus, Laser, RedLaser, BlueLaser, ShootingVirus, OrbitingVirus, EnemyLaser} from "./Entities.js";
...
export class MyScene extends Phaser.Scene
{
    ...
    preload()
    {
        ...
        this.load.image("blueLaser", "assets/BlueBullet.png");
        this.load.image("redLaser", "assets/RedBullet.png");
        this.load.image("enemyLaser", "assets/PurpleBullet.png");
    }
    ...
    create()
    {
      ...
      this.time.addEvent({
        ...
        callback: function() {
          var enemy = null;
          var int = Phaser.Math.Between(0, 17);
          if (int <= 2)
          {
          ...
          else if (int <= 14 && int > 11)
          {
            if (Phaser.Math.Between(0, 1) == 0)
            {
              enemy = new OrbitingVirus(
                this,
                0,
                Phaser.Math.Between(0, this.game.config.height)
              );
